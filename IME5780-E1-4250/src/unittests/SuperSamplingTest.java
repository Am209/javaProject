...
public class SuperSamplingTest {
	...
	/**
	 * Produce a picture of some spheres on a Plane lighted by a spot lights with Supersampling improvment
	 */
	@Test
	public void planeSpheres() {
		...
		ImageWriter imageWriter = new ImageWriter("superSampling improve", 200, 200, 600, 600,9,9);
