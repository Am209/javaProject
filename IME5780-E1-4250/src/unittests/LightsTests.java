...
public class LightsTests {
    ...
    public void trianglesSpot() {
        ...
        scene.addLights(new SpotLight(new Color(500, 250, 250),
                new Point3D(10, 10, 130),1, 0.0001, 0.000005, new Vector(-2, 2, 1)));
    ...
    public void trianglesMultipleLights() {
         ...
         scene.addLights(new DirectionalLight(new Color(200, 0, 100), new Vector(0, 0, 0.5)),new PointLight(new Color(250, 250, 100),
                 new Point3D(50, 50, 100),
                 1, 0.0005, 0.0005),new SpotLight(new Color(50, 0,200),
                 new Point3D(10, 10, 130),1, 0.0001, 0.000005, new Vector(0, 0, 1)));

         ImageWriter imageWriter = new ImageWriter("trianglesMultipleLights", 200, 200, 500, 500);
         Render render = new Render(imageWriter, scene);
    ...
    /**
     * Produce a picture of a two  sphere lighted by multiple lights
     */
    @Test
    public void sphereMultipleLights() {
         ...
         scene.addLights(new DirectionalLight(new Color(0, 500, 0), new Vector(0, 0, 1)),new PointLight(new Color(500, 0, 150),
        		 new Point3D(-50, 50, -50), 1, 0.00001, 0.000001),new SpotLight(new Color(500, 100, 100),
                 new Point3D(-100, -100, -100),1, 0.0001, 0.000005, new Vector(-2, 2, 1)));
